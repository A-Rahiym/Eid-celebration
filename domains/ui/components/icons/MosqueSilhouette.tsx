...
export default function MosqueSilhouette({ className }: MosqueSilhouetteProps) {
  return (
    <svg className={className} width="140" height="100" viewBox="0 0 140 100" fill="none" aria-hidden="true">
