...
export default function HeroOrnament({ className }: HeroOrnamentProps) {
  return (
    <svg className={className} viewBox="0 0 620 620" fill="none" aria-hidden="true">
      <g fill="none" stroke="rgba(201,169,110,1)" strokeWidth="0.8">
        ...
        <line x1="30" y1="455" x2="590" y2="165" />
